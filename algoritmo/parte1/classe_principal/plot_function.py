...
class PlotFunction():
    ...
    @staticmethod
    def plot_full(func, amostras1, amostras2, amostras3, limite):
        # Gerar 500 pontos no intervalo definido por limite
        x1 = np.linspace(limite[0,0], limite[0,1], 500)
        x2 = np.linspace(limite[1,0], limite[1,1], 500)
        ...
        # Coordenadas das amostras
        amostra_x1 = [amostra[0] for amostra in amostras1]
        amostra_x2 = [amostra[1] for amostra in amostras1]
        amostra_z = [amostra[2] for amostra in amostras1]
        ...
        ax.scatter(amostra_x1, amostra_x2, amostra_z, 
                ...
                # Coordenadas das amostras
        amostra_x1 = [amostra[0] for amostra in amostras2]
        amostra_x2 = [amostra[1] for amostra in amostras2]
        amostra_z = [amostra[2] for amostra in amostras2]

        # Plotar os pontos amostra sobre o gráfico, com zorder alto para ficar em primeiro plano
        ax.scatter(amostra_x1, amostra_x2, amostra_z, 
                   color='b',          # Cor vermelha para os pontos
                   s=100,              # Tamanho maior dos pontos
                   edgecolor='k',      # Borda preta ao redor dos pontos
                   zorder=5,           # Valor alto para renderizar os pontos na frente
                   label='LRS')
                ...
                # Coordenadas das amostras
        amostra_x1 = [amostra[0] for amostra in amostras3]
        amostra_x2 = [amostra[1] for amostra in amostras3]
        amostra_z = [amostra[2] for amostra in amostras3]

        # Plotar os pontos amostra sobre o gráfico, com zorder alto para ficar em primeiro plano
        ax.scatter(amostra_x1, amostra_x2, amostra_z, 
                   color='g',          # Cor vermelha para os pontos
                   s=100,              # Tamanho maior dos pontos
                   edgecolor='k',      # Borda preta ao redor dos pontos
                   zorder=5,           # Valor alto para renderizar os pontos na frente
                   label='LRS')
